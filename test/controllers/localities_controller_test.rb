...
class LocalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create locality" do
    assert_difference("Locality.count") do
      post localities_url, params: { locality: { locality: @locality.locality, province: @locality.province } }
    end
  ...
  test "should update locality" do
    patch locality_url(@locality), params: { locality: { locality: @locality.locality, province: @locality.province } }
