...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference("Bank.count") do
      post banks_url, params: { bank: { address: @bank.address, name: @bank.name, phone: @bank.phone } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { address: @bank.address, name: @bank.name, phone: @bank.phone } }
